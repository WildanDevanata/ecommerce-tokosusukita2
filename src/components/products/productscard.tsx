        ...
        <div className="relative w-full h-full">
          {product.image ? (
            ...
            <div className="w-full h-full flex items-center justify-center">
              <span className="text-7xl group-hover:scale-110 transition-transform duration-300">{product.emoji || '🛍️'}</span>
            </div>
          )}
        </div>
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        {product.rating > 0 && (
          <div className="mt-2 mb-3 flex items-center gap-1">
            ...
            {product.reviewCount > 0 && <span className="text-xs text-gray-400">({product.reviewCount.toLocaleString()})</span>}
          </div>
        )}
